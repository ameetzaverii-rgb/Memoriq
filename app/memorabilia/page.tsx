        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <a href="/" style={{ textDecoration: "none" }}>
            <span style={{ fontSize: 20, fontWeight: 900, letterSpacing: "-0.02em" }}>
              MEM<span style={{ color: "#F5A623" }}>O</span>RIQ
            </span>
          </a>
          <UserBar />
        </div>
          ...
          {categories.map(({ label, value }) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.2s",
                background: activeCategory === value ? "#F5A623" : "transparent",
                borderColor: activeCategory === value ? "#F5A623" : "rgba(255,255,255,0.12)",
                color: activeCategory === value ? "#000" : "rgba(255,255,255,0.6)",
              }}
            >
              {label}
            </button>
